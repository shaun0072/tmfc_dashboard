	...
	var add_form = '<div class="add_tr_form">';
				...
				add_form += '<table>';
					...
					add_form += '<tr>';
						...
						add_form += '<td><input type="number" class="reading"/></td>';
...
function update_cp_widget(app_obj) {
	...
	var temp_opt = app_obj['parameters']['temp']['optimum'],
		  temp_tmf_min = app_obj['parameters']['temp']['tmf_min'],
		  temp_tmf_max = app_obj['parameters']['temp']['tmf_max'],
		  temp_tds_min = app_obj['parameters']['temp']['tds_min'],
		  temp_tds_max = app_obj['parameters']['temp']['tds_max'],
		  pH_opt = null_to_na(app_obj['parameters']['pH']['optimum']),
			pH_tmf_min = null_to_na(app_obj['parameters']['pH']['tmf_min']),
			pH_tmf_max = null_to_na(app_obj['parameters']['pH']['tmf_max']),
			pH_tds_min = null_to_na(app_obj['parameters']['pH']['tds_min']),
			pH_tds_max = null_to_na(app_obj['parameters']['pH']['tds_max']);
  ...
  var tmf_temp_range = $('<td>', {
		html: '<span>'+temp_tmf_min+'</span> - <span>'+ temp_tmf_max+'</span>',
		data: {
  ...
  var tds_temp_range = $('<td>', {
		html: '<span>'+temp_tds_min+'</span> - <span>'+ temp_tds_max+'</span>',
		data: {
			column_name: "Change TMF ",
			table: "applications",
			changes: {
  ...
  var pH_opt = $('<td>', {
	...
	//pH tmf_range
  var tmf_pH_range = $('<td>', {
		html: '<span>'+pH_tmf_min+'</span> - <span>'+ pH_tmf_max+'</span>',
		data: {
	...
	//pH tds_range
  var tds_pH_range = $('<td>', {
		html: '<span>'+pH_tds_min+'</span> - <span>'+ pH_tds_max+'</span>',
		data: {
			column_name: "Change TMF ",
			table: "applications",
			changes: {
	 ...
	 if(app_obj['properties']) {
		 ...
		 for(var i=0; i < app_obj['properties'].length; i++) {
			...
			var id = app_obj['properties'][i]['property_id'],
				  ...
				  lastest_result = (app_obj['properties'][i]['test_results']) ? Math.round(app_obj['properties'][i]['test_results'][0]['result'] * 10) / 10 : "n/a";
			...
			var tmf_range = $('<td>', {
				class: "tmf_range",
				html: '<span>'+tmf_min+'</span> - <span>'+ tmf_max+'</span>',
				data: {
			...
			var tds_range = $('<td>', {
				class: "tds_range",
				html: '<span>'+tds_min+'</span> - <span>'+ tds_max+'</span>',
				data: {
